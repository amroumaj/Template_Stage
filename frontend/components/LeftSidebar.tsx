...
const LeftSidebar = ({ allShapes }: { allShapes: Array<any> }) => {
  ...
  const memoizedShapes = useMemo(
    () => (
      <section className="flex flex-col border-t min-w-[2px] absolute left-0 h-full max-sm:hidden select-none overflow-y-auto pb-20">
        <h3 className="border  px-5 py-4 text-xs uppercase">Layers</h3>
