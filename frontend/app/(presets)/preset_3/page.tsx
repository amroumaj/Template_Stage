...
import { handleCanvasMouseDown, handleCanvasMouseMove, handleCanvasMouseUp, handleCanvasObjectModified, handleCanvasObjectScaling, handleCanvasSelectionCreated, handlePathCreated, handleResize, initializePreset_3 } from "@/lib/canvas";
...
export default function Home() {
  ...
  useEffect (() => {
    const canvas = initializePreset_3({canvasRef, fabricRef})
