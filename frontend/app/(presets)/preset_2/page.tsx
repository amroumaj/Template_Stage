...
import { handleCanvasMouseDown, handleCanvasMouseMove, handleCanvasMouseUp, handleCanvasObjectModified, handleCanvasObjectScaling, handleCanvasSelectionCreated, handlePathCreated, handleResize, initializePreset_2 } from "@/lib/canvas";
...
export default function Home() {
  ...
  useEffect (() => {
    const canvas = initializePreset_2({canvasRef, fabricRef})
